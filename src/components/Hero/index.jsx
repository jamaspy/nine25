...
const index = () => {
  return (
    <div className="flex flex-col mt-12 md:flex-row md:justify-center relative overflow-hidden">
      <div className="">
      ...
      <div className="flex items-center -mt-36 md:mt-0 justify-end lg:mr-24">
        <HeroSVG />
      </div>
    </div>
  );
